...
import SuccessPage from "Views/PayView/Success";
        ...
        <div className="left-side">
          ...
          <li>
            ...
            >
              ...
              <img
                className="nav-icon"
                src={require("./Icons/AboutIcon.png")}
                alt="About"
              ></img>
            </NavLink>
          </li>
          ...
          <>
            <div className="right-side">
              <li>
                <NavLink
                  to="/login"
                  className="nav-link underline-effect nav-right"
                  activeclassname="active"
                >
                  {" "}
                  Login{" "}
      ...
      <main>
        <section>
          <Routes>
            ...
            <Route
              path="/login"
              element={<SigninModal setModalComponent={setModalComponent} />}
            />
            <Route
              path="/signup"
              element={<SigninModal setModalComponent={setModalComponent} />}
